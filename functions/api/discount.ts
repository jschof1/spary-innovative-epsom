// Cloudflare Pages Function - Discount Form Webhook Proxy
// The actual webhook URL is stored in Cloudflare environment variables

interface Env {
  DISCOUNT_WEBHOOK_URL: string;
}
...
export const onRequestPost: PagesFunction<Env> = async (context) => {
  ...
  const webhookUrl = env.DISCOUNT_WEBHOOK_URL || "https://services.leadconnectorhq.com/hooks/GDy3wBuzt9lhvXoDTcIb/webhook-trigger/cbMc9GToGvVEelqEPECY";
