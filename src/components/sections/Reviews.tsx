    ...
    <section className="bg-gradient-to-b from-white via-orange-50/40 to-white py-8 md:py-12 overflow-hidden relative" id="reviews">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mt-10">
          <a href={siteSettings.feedbackGoogleReviewUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-navy-900 font-bold hover:text-orange-500 transition-colors">
