      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div className={showForm ? "text-white text-center lg:text-left" : "text-center text-white max-w-4xl mx-auto"}>
            ...
            <motion.h1 
              className="font-header font-bold text-4xl md:text-6xl lg:text-7xl leading-tight mb-4 lg:mb-8"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.p 
              className={`text-xl md:text-2xl text-gray-200 mb-6 lg:mb-10 max-w-lg mx-auto lg:mx-0 ${!showForm && "mx-auto max-w-2xl"}`}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          {showForm && (
            <motion.div 
              className="w-full lg:ml-auto scroll-mt-24" 
              id="booking-form"
