            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  <Button size="lg" asChild className="bg-orange-500 hover:bg-orange-600 text-white border-none font-bold">
                    <a href={siteSettings.feedbackGoogleReviewUrl} target="_blank" rel="noopener noreferrer">Leave a Review</a>
                  </Button>
                  <Button size="lg" variant="outline" asChild className="border-white text-black hover:bg-orange-500 hover:text-white font-bold">
                    <a href={siteSettings.feedbackGoogleReviewUrl} target="_blank" rel="noopener noreferrer">View Google Reviews</a>
                  </Button>
                </div>
              </motion.div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mt-12 text-center">
                <Button size="lg" variant="outline" asChild className="border-navy-900 text-navy-900 hover:bg-navy-900 hover:text-white font-bold h-14 px-10">
                  <a href={siteSettings.feedbackGoogleReviewUrl} target="_blank" rel="noopener noreferrer">Show More Reviews</a>
                </Button>
              </div>
            </div>
          </div>
            ...
            <div className="bg-navy-900 rounded-3xl p-12 overflow-hidden relative">
              ...
              <div className="max-w-3xl relative z-10 text-center mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
                  <a href={siteSettings.feedbackGoogleReviewUrl} target="_blank" rel="noopener noreferrer" className="bg-white/5 hover:bg-white/10 p-6 rounded-xl border border-white/10 transition-colors flex flex-col items-center">
